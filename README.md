## Постановка задачи:
Есть N подлинных и (в идеале) N поддельных подписей. 

В Samara dataset собраны подписи 10 человек — для 7 из них имеются 16 поддельных и 16 подлинных подписей на каждого.
На 3 оставшихся человек пока что имеются лишь 16 подлинных подписей.
Всего на данный момент в Samara Dataset находится 256 подписей.

Нейронной сети необходимо определить, подлинная ли подпись на входе, или же она поддельна. 
